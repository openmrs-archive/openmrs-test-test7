 ...
 */
package org.openmrs.module.test7;
...
import org.openmrs.module.test6.PageModel;

/**
 * This class contains the logic that is run every time this module is either started or stopped.
 */
public class Test7Activator implements ModuleActivator {
	
	public static final String MODULE_ID = "test7";
	...
	public void willStart() {
		log.info("Starting Test7 Module");
		PageModel pageModel = new PageModel();
		pageModel.setName("Testing Name");
